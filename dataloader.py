import numpy as np               #导入了NumPy库，用于处理数组和矩阵等数值计算的操作
...
class LLCMData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img1 = self.transform_color1(img1)
        img1_1 = self.transform_color2(img1)
        img2 = self.transform_thermal1(img2)
        img2_1 = self.transform_thermal2(img2)

        return img1, img1_1, img2, img2_1, target1, target2
...
class RegDBData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # torchvision.transforms.functional.to_pil_image(img1_1).convert('RGB').save("./output/img11.jpg")
