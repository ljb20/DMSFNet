...
cfg.HEAD_KEEP=1
cfg.FREQUENCY_KEEP=14
cfg.AL=1

# dataset
cfg.DATASET = 'sysu'    # sysu or regdb
cfg.DATA_PATH_SYSU = '/root/SYSU-MM01/'
cfg.DATA_PATH_RegDB = '/root/RegDB/'
cfg.DATA_PATH_LLCM = '/root/LLCM/'
cfg.PRETRAIN_PATH = '/root/jx_vit_base_p16_224-80ecf9dd.pth'
...
cfg.H = 256
cfg.W = 128
cfg.BATCH_SIZE = 16  # num of images for each modality in a mini batch
